...
namespace In_Struct
{
    public partial class PopisInstrukcijaNereg : HelperFrm
    {
        List<Instrukcija> ins;
        public PopisInstrukcijaNereg()
        {
            InitializeComponent();
            postaviHelp("PregledInstrukcija.htm");
        }

        private void PopisInstrukcijaNereg_Load(object sender, EventArgs e)
        {
            OsvjeziDataGrid();
            PopuniKriterij();
        }
        ...
        private void btnDetalji_Click(object sender, EventArgs e)
        {
            ...
            if(dgvPopisInstrukcija.CurrentRow != null && dgvPopisInstrukcija.CurrentRow.DataBoundItem != null)
            {
            ...
            {
                MessageBox.Show("Niste odabrali nijednu instrukciju");
            }
